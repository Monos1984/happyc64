...
echo ----------------------------------------
echo * Compilation pour C64 en cartouche 8k *
echo ----------------------------------------
...
%cl65% -o %adr_out%/%prg_prog%.bin -O --config ../../cartridge/cart64_8k.cfg  --include-dir %adr_happy%/header %fichier% %adr_happy%\happyc64.lib %ADR_CARTOUCHE%/cart64_8k.o
